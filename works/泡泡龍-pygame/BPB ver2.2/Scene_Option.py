...
class Scene_Option:
    ...
    def __init__(self):
        ...
        self.button3_image = self.mfont.render("BN", 12, (192,0,0))
        self.button3_image_b = self.mfont.render("BN", 12, (127,127,127))
        ...
        self.ButtonGroup.add([self.button1, self.button2, self.button3, self.button4])
